        ...
        <div className="dropdown" style={{ height: menuHeight }} ref={dropdownRef}>
            ...
            <CSSTransition
                ...
                <div className="menu">
                    ...
                    <DropdownItem leftIcon={<BoltIcon />}>Déconnexion</DropdownItem>
                </div>
            </CSSTransition>
            ...
            <CSSTransition
                ...
                <div className="menu">
                    ...
                    <DropdownItem leftIcon={<ChevronIcon />}>Manoir en France</DropdownItem>
                    <DropdownItem leftIcon={<ChevronIcon />}>La villa en españa</DropdownItem>
                </div>
            </CSSTransition>
        </div>
    );
